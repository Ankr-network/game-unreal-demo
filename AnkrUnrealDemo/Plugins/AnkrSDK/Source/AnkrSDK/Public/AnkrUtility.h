...
UCLASS()
class ANKRSDK_API UAnkrUtility : public UObject
{
	GENERATED_BODY()
...
public:
	...
	static FString GetDefaultERC20();
	static FString GetDefaultERC721();
	static FString GetDefaultERC1155();

	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static FString GetDeviceID();
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static void SetDeviceID(FString _deviceId);
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static FString GetSession();
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static void SetSession(FString _session);
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static FString GetWalletConnectDeepLink();
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static void SetWalletConnectDeepLink(FString _walletConnectDeepLink);
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static bool GetNeedLogin();
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static void SetNeedLogin(bool _needLogin);
	...
	UFUNCTION(BlueprintCallable, Category = "AnkrUtility") static FString GetAdvertisementAppID();
